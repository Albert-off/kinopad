...
def home():
    return "<html><body><h1>✓ Kinopad Безопасный API работает!</h1></body></html>"
...
def get_episodes():
    ...
    try:
        # Извлекаем ID поста и озвучки из твоей ссылки
        ...
        # Генерируем обычный список серий, отдаем ID дальше в HTML
